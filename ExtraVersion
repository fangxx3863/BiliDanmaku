...
echo 输入季度
read season
season=$(echo $season|awk '{printf("%02d\n",$0)}')
...
do
	index=$(($index+1))
	echo "CID: $line"
	indexzl=$(echo $index|awk '{printf("%02d\n",$0)}')
	...
	python3 ../danmaku2ass/danmaku2ass.py -o ../AssOut/S${season}E${indexzl}${hz}.ass -s 1920x1080 -fn "$font" -fs 48 -a 0.8 -dm 5 -ds 5 $index.xml
done
